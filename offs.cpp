...
namespace Offsets
{
    ...
    constexpr uintptr_t dwEntityList       = 0x24AE268;    // Verified working offset
    constexpr uintptr_t dwLocalPlayerPawn  = 0x2068B60;    // Verified working offset
    constexpr uintptr_t dwViewMatrix       = 0x230EF20;    // Verified working offset
