...
namespace Offsets
{
    ...
    constexpr uintptr_t dwEntityList       = 0x24D0DC0;    // Verified working offset
    constexpr uintptr_t dwLocalPlayerPawn  = 0x2056700;    // Verified working offset
    constexpr uintptr_t dwViewMatrix       = 0x2330AE0;    // Verified working offset
